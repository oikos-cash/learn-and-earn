...
export const baseStyles = css`
  ...
  * {
  ...
  .navBarDefault {
    ...
    display: flex;
    align-items: center;
    box-shadow: -1px 0px 4px 1px rgba(200, 200, 200, 0.4);
    -webkit-box-shadow: -1px 0px 4px 1px rgba(200, 200, 200, 0.4);
    -moz-box-shadow: -1px 0px 4px 1px rgba(200, 200, 200, 0.4);
    -o-box-shadow: -1px 0px 4px 1px rgba(200, 200, 200, 0.4);
    z-index: 1;
    padding: 15px;
    position: relative;
    height: 80px;
